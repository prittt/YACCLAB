...
void LatexGenerator(const filesystem::path& output_path, const std::string& latex_file, const cv::Mat1d& all_res,
	const std::vector<cv::String>& datasets_name, const std::vector<cv::String>& ccl_algorithms,
