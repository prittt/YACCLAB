...
//Actions:
#include "labeling3D_BBDT_22c_action_def.inc.h"

template <typename LabelsSolver>
class BBDT_3D_22c : public Labeling3D<Connectivity3D::CONN_26> {
public:
	BBDT_3D_22c() {}
...
#include "labeling3D_BBDT_22c_action_def_mem.inc.h"
		}
