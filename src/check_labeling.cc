...
namespace {
    ...
    public:
        LabelingCheckAlgorithmsSet() {
            ...
            LabelingCheckSingleton3D::GetInstance().map_[CONN_6] = "naive_3D_UF";
            LabelingCheckSingleton3D::GetInstance().map_[CONN_18] = "naive_3D_UF";
            LabelingCheckSingleton3D::GetInstance().map_[CONN_26] = "naive_3D_UF";
        }
    } instance;
}