...
inline static
void firstScanOPTv2(const Mat1b &img, Mat1i& imgLabels, uint* P, uint &lunique) {
...
int labelingGranaOPTv2(const cv::Mat1b &img, cv::Mat1i &imgLabels) {
	...
	firstScanOPTv2(img, imgLabels, P, lunique);
