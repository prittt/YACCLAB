...
// Kang2016 GPU-BASED OBJECT IDENTIFICATION IN LARGE-SCALE IMAGES FOR REALTIME RADAR SIGNAL ANALYSIS
...
namespace {
	...
	// Background labels start at -1 in the paper.
...
class RADAR : public GpuLabeling2D<Connectivity2D::CONN_8> {
private:
	dim3 grid_size_;
	dim3 block_size_;
	char changes;
