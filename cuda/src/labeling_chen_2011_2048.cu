...
__device__ __inline__ static void detectRuns2048(ushort* pt, uchar* ct, uchar* ps, uchar* px, ushort* tbf, uint cp2)
{
    uint* ps4 = (uint*)ps;
    uint* pt2 = (uint*)pt;
...
__global__ static void pass1_2048(ushort* pt, uchar* ps, ushort* b, ushort* b2, uint h, ushort* eb)
{
...
__global__ static void pass2_2048(ushort* ib, uint* glabel, uint h, uint pitch)
{
...
__global__ static void pass3_2048(ushort* pt, ushort* ps, ushort* b, uint* label, uint h)
{
